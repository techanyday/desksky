...
def generate_slides_content(title, topic):
    """Generate slide content using the topic."""
    # For now, let's create a simple 5-slide presentation structure
    slides = [
        {
            'title': title,
        ...
        },
        {
            ...
            'bullets': [
                ...
                'Key aspect 2 of ' + topic,
                'Key aspect 3 of ' + topic
            ]
        },
        {
            'title': 'Deep Dive',
...
def create_slides():
    ...
    try:
        ...
        slides_content = generate_slides_content(title, topic)
